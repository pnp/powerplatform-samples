...
This is a Canvas App that enables you to quickly convert from one colour code to another, including choosing a transparency value and copying the resulting code with the click of a button!
